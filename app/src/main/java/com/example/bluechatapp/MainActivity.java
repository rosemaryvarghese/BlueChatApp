...
public class MainActivity extends AppCompatActivity {
    ...
    private final int loc_per_request = 101;
    ...
    private void checkperm()
    {
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(MainActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, loc_per_request);
        } else {
            Intent intent = new Intent(context, DevLActivity.class);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull @org.jetbrains.annotations.NotNull String[] permissions, @NonNull @org.jetbrains.annotations.NotNull int[] grantResults) {
        if(requestCode==loc_per_request){
